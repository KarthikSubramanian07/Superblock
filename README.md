...
## 📂 Project Structure
- [**Master README (Technical)**](file:///Users/karthik/Desktop/Superblock/LA_Hacks/backend_service/README.md): Full technical breakdown, API contracts, and install guides.
- [**Frontend Dashboard**](file:///Users/karthik/Desktop/Superblock/superblock-ui): Live 3D Digital Twin (Deck.gl) and Agent Panel.
- [**ZETIC Edge Node**](file:///Users/karthik/Desktop/Superblock/LA_Hacks/backend_service/scripts/zetic_mac_edge_node.py): Hardware simulator for NPU inference.
- [**ASI:One Skill**](file:///Users/karthik/Desktop/Superblock/LA_Hacks/backend_service/scripts/asi1_superblock_skill.py): Discoverable chat agent for Agentverse.
